...
def submit_booking():
    try:
        ...
        confirm_link = f"https://booking-repository-19.onrender.com/confirm-booking?email={email}&first_name={first_name}&last_name={last_name}"
...
background:#0a66c2; color:#fff; padding:12px 18px;
text-decoration:none; border-radius:4px;">↩️ Reply to Customer</a>

<br><br>

<a href="{confirm_link}"
style="display:inline-block; background:#198754; color:#fff;
padding:14px 22px; text-decoration:none; border-radius:6px; font-weight:bold;">
✅ Confirm Booking</a>

</td>
</tr>

<tr><td align="center" style="font-size:12px; color:#777; padding:15px;">
...
style="display:inline-block; margin:15px 0; background:#25D366;
color:#fff; padding:12px 20px; text-decoration:none; border-radius:4px;">
📲 Chat on WhatsApp</a>

<p style="margin-top:20px;">
Warm regards,<br>
<b>Moffassa Travellers</b>
</p>
</td>
</tr>
